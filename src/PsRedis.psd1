#
# Module manifest for module 'PsRedis'
#
...
@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            Tags = @('powershell', 'redis')

            # A URL to the license for this module.
            LicenseUri = 'https://raw.githubusercontent.com/Badgerati/PsRedis/master/LICENSE.txt'

            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/Badgerati/PsRedis'
